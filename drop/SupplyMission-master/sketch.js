...
var packageBody,ground,dropA1,dropA2,dropA3,dropA1s,dropA2s,dropA3s,packageBody2,packageSprite2,ground2,groundSprite2
...
function setup() {
	...
	groundSprite2=createSprite(width/2, height-35, width,10);
	groundSprite2.shapeColor=color(255)

	dropA1s=createSprite(400, 650, 200,20);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 ground2 = Bodies.rectangle(width/2, 630, width, 10 , {isStatic:true} );
